...
.nav-tab:hover { background: #4CAF50; color: #fff; border-color: #4CAF50; }
...
thead { background: rgba(76, 175, 80, 0.1); position: sticky; top: 0; z-index: 10; }
th { padding: 12px 8px; text-align: left; font-weight: bold; color: #4CAF50; border-bottom: 2px solid #4CAF50; white-space: nowrap; }
td { padding: 10px 8px; border-bottom: 1px solid #222; }
tr:hover { background: rgba(76, 175, 80, 0.05); }
...
.country-badge { padding: 2px 6px; background: rgba(76, 175, 80, 0.1); border-radius: 3px; font-weight: bold; }
.trend-up2 { color: #4CAF50; font-weight: bold; }
.trend-up1 { color: #7FD05A; }
...
.footer-link { margin: 0 15px; cursor: pointer; color: #4CAF50; text-decoration: none; }
...
.modal { background: #111; padding: 30px; border-radius: 10px; max-width: 500px; width: 90%; border: 1px solid #4CAF50; }
...
'<button class="nav-tab active" onclick="location.href=\'tennis_matrix.html\'">ATP Tennis</button>',
'<button class="nav-tab" onclick="location.href=\'wta_matrix.html\'">WTA Tennis</button>',
...
'</div>',
'<div class="container">',
'<div class="matrix-title">ATP Tennis Matrix <span id="playerCount"></span></div>',
'<div class="matrix-subtitle">Clay Court Stats | 2022-2026 | Madrid Open Preview</div>',
'<div class="legend">',
...
'</div>',
'<div class="footer">The Gain Line | ATP 727 Players | Sackmann 2022-2024 + TennisMyLife 2025-2026 | Generated ' + generated + '</div>',
