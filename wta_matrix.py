...
def load_wta_data():
    """Load WTA player data from JSON."""
    try:
        ...
        print("Error: wta_data.json not found. Run build_data.py first.")
        return []
...
def generate_html(players):
    """Generate HTML table for WTA tennis players."""
...
<body>
    <div class="container">
        <div class="header">
            <h1>WTA Tennis Player Matrix</h1>
        ...
        <div class="nav-tabs">
            ...
            <button class="nav-btn" onclick="navigateTo('tennis_matrix.html')">ATP Tennis</button>
            <button class="nav-btn active" onclick="navigateTo('wta_matrix.html')">WTA Tennis</button>
...
def main():
    """Main function to generate WTA tennis matrix."""
    players = load_wta_data()
    
    if not players:
        print("No player data found.")
        return
    
    print(f"Loaded {len(players)} WTA players")
    
    html_output = generate_html(players)
    
    with open('wta_matrix.html', 'w', encoding='utf-8') as f:
        f.write(html_output)
